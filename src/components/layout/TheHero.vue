<template>
  <section
    class="hero relative flex flex-col items-center justify-center text-center
           min-h-[600px] md:min-h-[700px] lg:min-h-[750px] xl:min-h-[800px]
           bg-gradient-to-b from-indigo-100 to-white overflow-hidden px-4"
  >
    <!-- Decorative Circles -->
    <div class="decorative-circle circle-1 z-0 block md:block"></div>
    <div class="decorative-circle circle-2 z-0 block md:block"></div>
    <div class="decorative-circle circle-3 z-0 hidden md:block"></div>
    <div class="decorative-circle circle-4 z-0 hidden md:block"></div>
    <div class="decorative-circle circle-5 z-0 hidden md:block"></div>
    ...
    <!-- Hero Description -->
    <p class="text-gray-700 max-w-2xl mb-8 z-10 text-base md:text-lg lg:text-xl">
      Streamline your customer support and handle all tickets in one place. Join
      thousands of businesses using TicketMaster to enhance their support experience.
    </p>

    <!-- CTA Buttons -->
    <div class="flex flex-col sm:flex-row gap-4 z-10 justify-center">
      <RouterLink
        to="/login"
        class="px-8 py-3 rounded-lg font-semibold text-white bg-gradient-to-r 
      ...
      <RouterLink
        to="/signup"
        class="px-8 py-3 rounded-lg font-semibold text-green-600 border-2 border-green-500 
...
<script setup>
import { ArrowRightIcon, UserPlusIcon } from "@heroicons/vue/24/solid";
